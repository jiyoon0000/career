package com.example.career.global.error.response;
...
public class ErrorResponse {
    ...
    public static ResponseEntity<ErrorResponse> toResponseEntity(ErrorCode errorCode, String path, String method) {
